  ...
  <main>
    <section class="section py-12 sm:py-16 md:py-20">
      <div>
        ...
        <h1 class="h1 mt-2">Historie</h1>
        <p class="muted mt-3 max-w-3xl">Počátky kopané v Bílovicích a vývoj klubu od roku 1917 do 1962.</p>
      </div>

      <div class="mt-8 grid gap-8 md:grid-cols-2">
        <!-- 1917–1924 -->
        <article class="card p-6 sm:p-8">
          <p class="kicker">1917–1924</p>
          <h2 class="h2 mt-2">Počátky kopané</h2>
          <div class="muted mt-3 space-y-3 leading-relaxed">
            <p>
        ...
        <!-- 1924–1932 -->
        <article class="card p-6 sm:p-8">
          <p class="kicker">1924–1932</p>
          <h2 class="h2 mt-2">A.F.K. Bílovice nad Svitavou</h2>
          <div class="muted mt-3 space-y-3 leading-relaxed">
            <p>
        ...
        <!-- 1932–1938 -->
        <article class="card p-6 sm:p-8">
          <p class="kicker">1932–1938</p>
          <h2 class="h2 mt-2">Sportovní klub Bílovice n. S.</h2>
          <div class="muted mt-3 space-y-3 leading-relaxed">
            <p>
        ...
        <!-- 1938–1962 -->
        <article class="card p-6 sm:p-8">
          <p class="kicker">1938–1962</p>
          <h2 class="h2 mt-2">Poválečné období a snahy o obnovu</h2>
          <div class="muted mt-3 space-y-3 leading-relaxed">
            <p>
...
useHead({
  title: 'O nás – Historie | FC Aurora',
  meta: [
    { name: 'description', content: 'Historie fotbalu v Bílovicích nad Svitavou – počátky kopané od roku 1917 až po obnovení zájmu v roce 1962.' }
  ]
})
</script>
